...
from app.controllers.compliance.TR import upload_tr,get_tr,findTrToc,FindTrRequirement, findTrHSCode, FindTrStd,get_tr_toc
...
complianceRouter.get("/get-tr-toc")(get_tr_toc)
