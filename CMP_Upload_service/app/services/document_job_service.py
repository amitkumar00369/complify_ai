...
class DocumentJobService:
    ...
    async def create_job(
        ...
        print("Creating Job with Payload:", payload)

        job = DocumentJob( id=payload.get("id"), module=payload["module"], file_name=payload["file_name"], storage_path=payload["s3_key"], file_hash=payload.get( "file_hash" ), status="queued", total_files=payload.get( "total_files", 0 ), processed_files=0, failed_files=0 )
